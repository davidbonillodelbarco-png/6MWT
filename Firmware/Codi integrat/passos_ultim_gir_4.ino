...
const float STEP_THRESHOLD = 3.4;    // SUBIDO: Punto intermedio para ignorar ruido de pisada
const int STEP_TIMEOUT = 500;        // SUBIDO: Medio segundo estricto para anular rebotes de cadera
